...
const BrowsePage = () => {
  ...
  return (
    <div className="flex h-screen bg-linear-to-b from-black to-[#5B0203] text-white">
      {/* === Sidebar === */}
      <Sidebar isActive={activeSection === SECTIONS.SIDEBAR} onNavigate={(key) => handleNavigation(key, SECTIONS.SIDEBAR)} />

      {/* === Main Content === */}
      <div ref={pageRef} className="flex-1 overflow-y-auto relative h-screen bg-linear-to-r from-black/95 via-black/55 to-transparent scrollbar-hide" >
